...
- [thinking.py](./examples/thinking.py) - Extended thinking example
- [thinking_stream.py](./examples/thinking_stream.py) - Streaming thinking example
- [tools.py](./examples/tools.py) - Tool/function calling example
- [tools_stream.py](./examples/tools_stream.py) - Streaming with tools example

### TypeScript Examples

- [cancellation.ts](./examples/cancellation.ts) - Request cancellation example
