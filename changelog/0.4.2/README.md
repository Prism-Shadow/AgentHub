...
- [2026-08-16] Changelog entries carry a metadata block with explicit PR links, and the dev skill gains a capture-serialization rule and a shared-test rule. ([details](2026-08-16-changelog-format-and-skill-rules.md))
