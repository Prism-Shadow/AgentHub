...
- [2026-03-04] Claude 4.6 is supported. We switch to using the adaptive thinking and `effort` parameter instead of the thinking budget. Supports Gemini on Vertex AI. Add Kimi-K2.5 model. Claude 4.5 models are deprecated. ([details](2026-03-04-claude-4-6-adaptive-thinking.md), [#81](https://github.com/Prism-Shadow/agenthub/pull/81), [#82](https://github.com/Prism-Shadow/agenthub/pull/82))

- [2026-02-26] Supports Claude on Amazon Bedrock. Bedrock requires image base64 encoding, we convert images to base64 in the client. ([details](2026-02-26-claude-bedrock.md), [#79](https://github.com/Prism-Shadow/agenthub/pull/79))
