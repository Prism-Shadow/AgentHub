...
- [2026-08-20] `AutoLLMClient` lists the model ids the configured endpoint serves. ([details](2026-08-20-list-models.md), [#181](https://github.com/Prism-Shadow/agenthub/pull/181))
