...
- `thinking_summary` (`bool`): Request a thinking summary when supported. Gemini returns summaries only on some models (2.5-flash and 3.1-pro do; the 3.5-3.8 flash models do not).
