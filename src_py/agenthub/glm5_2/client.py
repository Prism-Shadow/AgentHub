...
class GLM5_2Client(LLMClient):
    """GLM-5.2-specific LLM client implementation using OpenAI-compatible API."""

    def __init__(self, model: str, api_key: str | None = None, base_url: str | None = None):
        """Initialize GLM-5.2 client with model and API key."""
        self._model = model
    ...
    def _convert_thinking_level_to_config(self, thinking_level: ThinkingLevel) -> dict[str, str | bool]:
        """Convert ThinkingLevel enum to GLM-5.2's thinking configuration."""
        mapping = {
    ...
    def _convert_thinking_level_to_reasoning_effort(self, thinking_level: ThinkingLevel) -> str | None:
        """Convert ThinkingLevel enum to GLM-5.2's reasoning_effort.

        The server maps low/medium to high and xhigh to max; NONE disables thinking instead.
        """
        mapping = {
