...
> Snapshot note: the Returns section (the full Response-object schema) is omitted; the
> live captures under `api_captures/openai_responses/` record the streamed response shapes.
