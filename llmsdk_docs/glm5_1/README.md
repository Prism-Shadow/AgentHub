# GLM-5.1 SDK Documentation


This directory contains comprehensive documentation and examples for using GLM-5.1 API.
...
The `docs/` folder contains detailed guides on various GLM-5.1 features:
...
- [stream-tool.md](./docs/stream-tool.md) - Tool streaming output
