...
Thinking is activated by default in GLM-5.3 GLM-5.2 GLM-5.1 GLM-5 GLM-4.7 series, different from the default hybrid thinking in GLM-4.6.

> If you want to disable thinking, use the following (note that `GLM-5.3` uses forced thinking and cannot be disabled):
